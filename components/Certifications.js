        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mt-12">
          {certificationsData.map((cert, index) => (
            <div
              ...
              className="glass-card group cursor-pointer rounded-xl overflow-hidden transition-all duration-300 hover:shadow-xl"
            >
              {/* Certificate Image */}
              <div className="relative aspect-[4/3] overflow-hidden bg-gradient-to-br from-blue-950/40 to-slate-900/40">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-blue-950/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="flex items-center gap-2 bg-blue-500/80 backdrop-blur-sm text-white text-sm font-semibold px-4 py-2 rounded-full border border-blue-300/40 shadow-lg">
